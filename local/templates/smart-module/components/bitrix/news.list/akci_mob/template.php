...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	?>
	<?
	$diff = abs(strtotime(date('d.m.Y H:i:s')) - strtotime($arItem["PROPERTIES"]["ENDDATE"]["VALUE"]));
	...
	?>
	<div class="promo_block mobile">
		<?if(strtotime(date('d.m.Y H:i:s'))<strtotime($arItem["PROPERTIES"]["ENDDATE"]["VALUE"])):?>
		...
		<form action="">
			...
			<input type="text" class="p-popup__input" name="phone" placeholder="+7 (___) ___-__-__">
