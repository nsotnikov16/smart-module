		...
		<div class="mysidebar">
			...
			<? if ($isFilter) { ?>
				<div id="filter_header" class="mysidebar_block filter_block">
					<div class="zagolovok">Фильтр</div>
					<?
					$APPLICATION->IncludeComponent(
						"kombox:filter",
						"horizontal",
...
@media only screen and (max-width:768px) {
	...
	.mysidebar{
		...
		<?}?>
			...
			if($USER->isAdmin())
			{
				...
				echo"<pre>";print_r($issetCondition);echo"</pre>";
			}
			/**
	...
	<? if(!empty($same)):?>
    	...
    	<?endif;?>    
        		<?
				 if($IMG_1 == '' && $URL_1 == '' && $TITLE_1 == '' && $IMG_2 == '' && $URL_2 == '' && $TITLE_2 == ''){}else { ?>
        <div class="similar">
			<div class="row">
				<p class="similar_title_text">Похожие разделы </p>
				<?
				 if($IMG_1 == '' && $URL_1 == '' && $TITLE_1 == ''){}else { ?>
