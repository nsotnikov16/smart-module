		...
		<?else:*/?>
			...
			<?if ($arItem["PERMISSION"] > "D"):?>
				...
				<?if ($arItem["DEPTH_LEVEL"] == 1):?>
					...
					<div class="f-menu" <?if($previousLevel==0){?>style="display:block;float:left;margin-right:10px"<?}?>>
				...
				<?else:?>
					<li class="f-menu__item">
						...
						<a href="<?=$arItem["LINK"]?>" <?if($arItem["LINK"] == "/catalog/sooruzheniya-i-zdaniya-iz-metallokonstruktsiy/"):?>style="top: 5px;"<?endif?> class="f-menu__link active">
