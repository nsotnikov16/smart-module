...
if (0 < $arResult["SECTIONS_COUNT"]) {?>
	...
	<ul class="filter-sections-list">
		...
		foreach ($arResult['SECTIONS'] as &$arSection) {
			...
			<li class="list <?if(count($arSubSections)>0):?>list_no_before<?endif;?>" id="<?=$this->GetEditAreaId($arSection['ID'])?>">
				<a href="<?=$arSection["SECTION_PAGE_URL"]?>" class="link"><?= $arSection["UF_TITLEMENU"] ? $arSection["UF_TITLEMENU"] : $arSection["NAME"]?></a>
